...
public class Application {
        ...
        do{
            ...
            switch (no){
                ...
                case 3:
                    ...
                    break;
                case 4:
                    menuController.updateMenu(updateInputMenu());
                    break;
                case 5:
                    menuController.deleteMenu(inputCode());
                    break;
    ...
    public static Map<String,String> updateInputMenu() {
        System.out.println("수정하고 싶은 메뉴 코드를 입력 해주세요 : ");
        String code = sc.nextLine();
        System.out.println("수정할 메뉴 이름을 입력 해주세요 : ");
        String name = sc.nextLine();
        System.out.println("수정할 메뉴 가격을 입력 해주세요 : ");
        String price = sc.nextLine();
        System.out.println("수정할 카테고리 코드를 입력 해주세요 : ");
    ...
    // 특정 메뉴 코드를 입력 받아 해당 메뉴 조회 혹은 삭제 메소드
